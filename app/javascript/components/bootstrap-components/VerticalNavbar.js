...
import vibrantImg from '../../../assets/images/generic/vibrant.png';
    ...
    <Fragment>
      ...
      <Card className="mb-3">
        ...
        <CardBody className="bg-light">
          ...
          <code>app/javascript/context/Context.js</code> and set initial navbar collapse state like{' '}
          <code>isNavbarVerticalCollapsed: false</code> into <code>AppContext</code> then go to <code>app/javascript/Main.js</code>{' '}
